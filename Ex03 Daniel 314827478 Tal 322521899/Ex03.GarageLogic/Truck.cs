...
namespace Ex03.GarageLogic
{
    internal class Truck : Vehicle
    {
        ...
        public Truck(string i_ModelName, string i_LicenseNumber, EnergySource i_energySource,string i_ManufacturerName) : base(i_ModelName, i_LicenseNumber,
            createTiresList(i_ManufacturerName), i_energySource) ///added string i_ManufacturerName
        {
        }
